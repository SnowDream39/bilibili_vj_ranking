...
file_path = '特殊/特殊原始数据/梦的结唱.xlsx'
output_path = '特刊/梦的结唱特刊筛选前.xlsx'
...
def main_processing(data_path, output_path, point_threshold=None):
    ...
    info_list = process_records(data)
...
if __name__ == "__main__":
    main_processing(file_path, output_path)
