...
class WeeklyHonor:
    def __init__(self, out_dir: str, load_s: int, data: Dict[int, Tuple[List[str], pd.DataFrame, str]], target_p: int, hist_win: int):
    ...
    def save_report(self, idx: int, date_s: str, report_data: Dict[AchiType, List[AchievedSong]]):
        ...
        logger.info(f"已保存成就报告: {out_f.name}")
